...
from effects import draw_key_effect, spam_flying_notem update_and_draw_flying_notes
...
def creare_key_rects(num_keys, start_x = 50, start_y = 100, key_width=100, key_height=250):
    rects = []
